...
func BookMove(b *game.Board) *game.Move {
	...
	if b.Move == 1 && b.Active == game.WHITE {
		// 1.d4
		move := game.NewMove(b.Squares[game.D2], game.D4, game.D2)
		return &move
	}
	if b.Move == 1 && b.Active == game.BLACK {
		// 1.c6
		move := game.NewMove(b.Squares[game.C7], game.C6, game.C7)
		return &move
	}
	if b.Move == 2 && b.Active == game.WHITE {
		// 2.c4
		move := game.NewMove(b.Squares[game.C2], game.C4, game.C2)
		return &move
	}
